...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Static Page /</span> Edit</h4>
                        ...
                        <form action="" method="post" name="pageForm" id="pageForm">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $page->name }}" name="name" id="name" type="text" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $page->slug }}" name="slug" id="slug" type="text" class="form-control"
