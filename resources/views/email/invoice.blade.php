                ...
                <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" border="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <img src="{{ asset('front-assets/images/logo/logo.png') }}"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="640" role="presentation"
                        ...
                        <tbody>
                            <tr>
                                <td align="center">
                                    <img src="{{ asset('front-assets/email/invoice-order-icon.png') }}"
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#f9f9f9" align="left"
                                                ...
                                                Order Invoice #{{ $invoiceData['order']->id }}
                                            </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#FFFFFF">
                                    <tbody>
                                        @foreach ($invoiceData['order']->items as $item)
                                        <tr>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                            <td bgcolor="#FFFFFF" align="left"
                                                ...
                                                {{ substr($item->name,0, 40) }} ({{ $item->qty }})
                                            </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ number_format($invoiceData['order']->subtotal,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ number_format($invoiceData['order']->discount,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF" align="right"
                                            style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            {{ number_format($invoiceData['order']->shipping,2) }}$
                                        </td>
                                        <td bgcolor="#FFF" width="40" align="left"
                                            style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                        </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                ...
                                                class="table-container">
                                                {{ number_format($invoiceData['order']->grand_total,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    {{ $invoiceData['order']->address }}, {{ $invoiceData['order']->apartment }}, ({{ $invoiceData['order']->zip }}) - {{ $invoiceData['order']->city }},  {{ $invoiceData['order']->state }}, {{ getCountryInfo($invoiceData['order']->country_id)->name }}.
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    style="color: #111111; font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 14px;font-weight:normal;">
                                                    Paid by
                                                    @if ($invoiceData['order']->payment == "cod")
                                                        Cash On Delivery.
                                                    @else
                                                        {{ $invoiceData['order']->payment }}.
                                                    @endif 
                                            ...
                                            <tr class="social-icons">
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="https://www.MailerSend.com/" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-facebook-white.png') }}"
                                                            alt="Social Icons" width="30" height="30"
                                                            class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;;">
                                                    <a href="https://www.MailerSend.com/" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-twitter-white.png') }}"
                                                            alt="Social Icons" width="30" height="30"
                                                            class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="https://www.MailerSend.com/" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-linkedin-white.png') }}"
                                                            alt="Social Icons" width="30" height="30"
                                                            class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="https://www.MailerSend.com/" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-instagram-white.png') }}"
                                                            alt="Social Icons" width="30" height="30"
                                                            class="social-icon"></a>
                                                </td>
                                            </tr>
