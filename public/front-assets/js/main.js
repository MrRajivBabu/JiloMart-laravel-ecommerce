(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        quantityRanger: function() {
            // $('.pro-qty').prepend('<span class="input-group-btn"><button class="dec qtybtn sub" data-id="{{ $cartItem->rowId }}">-</button></span>');
            // $('.pro-qty').append('<span class="input-group-btn"><button class="inc qtybtn add" data-id="{{ $cartItem->rowId }}">+</button></span>');
