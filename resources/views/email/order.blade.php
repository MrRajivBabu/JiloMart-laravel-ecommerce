                ...
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="640" role="presentation"
                        ...
                        <tbody>
                            <tr>
                                <td align="center">
                                    <img src="{{ asset('front-assets/email/shop-order-icon.png') }}" alt="Section Image" width="120" height="120"
                                        class="alert-icon">
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"
                                    style="color:#45535C;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:800;font-size:22px;-webkit-font-smoothing:antialiased;line-height:1.2;"
                                    class="table-container mobile-title">
                                    Hi there!
                                </td>
                            </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#f9f9f9" align="left"
                                                ...
                                                Order Confirmation #{{ $mailData['order']->id }}
                                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ number_format($mailData['order']->subtotal,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ number_format($mailData['order']->discount,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ number_format($mailData['order']->shipping,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF" align="right"
                                                ...
                                                class="table-container">
                                                {{ number_format($mailData['order']->grand_total,2) }}$
                                            </td>
                                            <td bgcolor="#FFF" width="40" align="left"
                                                style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                            </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    {{ $mailData['order']->address }}, {{ $mailData['order']->apartment }}, ({{ $mailData['order']->zip }}) - {{ $mailData['order']->city }},  {{ $mailData['order']->state }}, {{ getCountryInfo($mailData['order']->country_id)->name }}.
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table cellpadding="0" cellspacing="0" border="0" align="right" width="270"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    style="color: #111111; font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 14px;font-weight:normal;">
                                                    {{ \Carbon\Carbon::parse($mailData['order']->created_at)->format('d M, Y') }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr class="social-icons">
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="#" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-facebook-white.png') }}" alt="Social Icons"
                                                            width="30" height="30" class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;;">
                                                    <a href="#" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-twitter-white.png') }}" alt="Social Icons"
                                                            width="30" height="30" class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="#" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-linkedin-white.png') }}" alt="Social Icons"
                                                            width="30" height="30" class="social-icon"></a>
                                                </td>
                                                <td style="padding:0 10px 0 10px;">
                                                    <a href="#" target="_blank"><img
                                                            src="{{ asset('front-assets/email/social-instagram-white.png') }}" alt="Social Icons"
                                                            width="30" height="30" class="social-icon"></a>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                        style="width: 640px; min-width: 640px;" role="presentation" class="table-container ">
                        <tr>
